...
const Home = () => {
  ...
  return (
    <div className="bg-[#fcfdfc] text-[#1b2e1e] min-h-screen">
      {/* 🔹 FLOATING GLASSMORPHIC NAVBAR (DARK GREEN THEME) */}
      <nav
        className={`fixed top-4 left-1/2 -translate-x-1/2 w-[92%] max-w-6xl h-16 rounded-2xl z-[100] transition-all duration-300 flex items-center justify-between px-6 md:px-8 bg-emerald-950/90 backdrop-blur-md border border-emerald-900/30 ${
          scrolled
            ? "shadow-xl border-emerald-800/50 bg-emerald-950/95"
            : "shadow-md"
        }`}
      >
        {/* Brand/Logo */}
        ...
        {/* Desktop Menu */}
        <ul className="hidden md:flex items-center gap-8 font-medium text-sm text-emerald-100/90">
          <li
            onClick={() => scrollToSection("hero")}
        ...
        <div className="hidden md:flex items-center gap-4">
          <button
            ...
            className="h-10 px-5 rounded-xl bg-white text-emerald-950 font-bold text-sm hover:bg-emerald-50 hover:shadow-lg hover:shadow-white/10 transition-all duration-200"
          >
            Get Started
          </button>
        </div>
        ...
        <button
          ...
          className="md:hidden p-2 rounded-lg text-emerald-100 hover:bg-emerald-900/40 hover:text-white transition-colors"
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div
              ...
              className="absolute top-20 left-0 right-0 p-6 rounded-2xl bg-emerald-950 border border-emerald-900 shadow-2xl flex flex-col gap-4 z-50 md:hidden mx-2 text-emerald-100"
            >
              <ul className="flex flex-col gap-4 text-emerald-100/90 font-medium">
                <li
                  onClick={() => scrollToSection("hero")}
                  className="py-2 border-b border-emerald-900/50 cursor-pointer hover:text-white"
                >
                  Home
                </li>
                <li
              ...
              <button
                onClick={handleNavigation}
                className="w-full py-3 rounded-xl bg-white text-emerald-950 font-bold text-center hover:bg-emerald-50 transition-colors mt-2"
              >
                Get Started
              </button>
            </motion.div>
          ...
          <div className="w-[90%] max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center z-10">
            ...
            >
              ...
              <p className="text-slate-600 text-base md:text-lg mb-8 leading-relaxed max-w-xl">
                AgroGeek bridges the gap between local farmers and sustainable
                industries. We eliminate middlemen, empowering local communities
                by turning agricultural waste and unutilized flora into valuable
      ...
      <div className="bg-emerald-950 py-12 relative overflow-hidden text-white">
        ...
        <div className="w-[90%] max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4 relative z-10 text-center">
          <div>
            <h3 className="text-4xl md:text-5xl font-extrabold text-emerald-400">
              5,000+
            </h3>
          ...
          <div className="w-[90%] max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-slate-600 leading-relaxed mb-6">
                Our local environment faces dual challenges: organic resources
                are routinely wasted, and leaves or wood are incinerated,
                contributing to severe air quality decline. At the same time,
                domestic Ayurvedic and pharmaceutical organizations are forced
                to import native flora from international suppliers.
              </p>
              <p className="text-slate-600 leading-relaxed mb-8">
                <strong>AgroGeek</strong> intercepts this supply-chain failure.
                By collecting and cataloging unutilized vegetation and
                manufacturing waste, we create a verified, fair-value bridge
                directly connecting local harvesters with national enterprises.
              </p>
          ...
          <div className="w-[90%] max-w-6xl mx-auto">
            ...
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-slate-600 text-base md:text-lg">
                Fostering an ecosystem built on trust, efficiency, and resource
                optimization. Discover how our specialized digital tools serve
            ...
            >
              ...
              >
                <div>
                  ...
                  <p className="text-slate-500 text-sm leading-relaxed">
                    Eliminate broker fees. Direct negotiation interface between
                    agricultural producers and business owners.
                  </p>
                </div>
              ...
              >
                <div>
                  ...
                  <p className="text-slate-500 text-sm leading-relaxed">
                    Sell agricultural leftovers, timber fragments, and excess
                    flora that would otherwise be discarded or burned.
                  </p>
                </div>
                <div className="mt-6 pt-4 border-t border-slate-50">
                  <span
            ...
            >
              ...
              <div className="w-full lg:w-1/2 text-left flex flex-col items-start justify-center">
                ...
                <p className="text-slate-600 leading-relaxed mb-6">
                  By cataloging agricultural byproduct locations, we minimize
                  supply delays, cut transportation footprints, and guarantee
                  fair-trade values for farmers. Businesses get local access to
                  raw ingredients, and local areas get cleaner air by keeping
                  waste out of firepits.
                </p>
                <button
                  onClick={handleNavigation}
          ...
          <div className="w-[90%] max-w-6xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-slate-600">
                A simple three-step architecture designed to transition unused
                materials into economic assets.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-slate-500 text-sm max-w-xs">
                  Register as a Seller (Farmer/Harvester) or Buyer
                  (Ayurvedic/Industrial Enterprise) to build your profile.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-slate-500 text-sm max-w-xs">
                  Sellers catalog their local flora or timber waste. Companies
                  browse geo-mapped listings looking for matching components.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-slate-500 text-sm max-w-xs">
                  Establish straight-to-producer trade pipelines with clear
                  specifications, locked pricing, and direct communications.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="py-20 bg-gradient-to-r from-emerald-800 to-green-950 text-white text-center relative overflow-hidden">
        ...
        <div className="w-[90%] max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-slate-200 text-base md:text-lg mb-8 max-w-2xl mx-auto">
            Whether you want to earn value from organic waste products or secure
            localized raw botanical materials, AgroGeek is here for you.
          </p>
      ...
      <footer
        id="footer"
        className="bg-emerald-950 border-t border-emerald-900/60 pt-16 pb-8 text-slate-300 relative overflow-hidden"
      >
        ...
        <div className="w-[90%] max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 pb-12 border-b border-emerald-900 z-10 relative">
          ...
          <div className="lg:col-span-4 flex flex-col items-start">
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-6 text-left">
              Transforming B2B agricultural sourcing by turning localized flora
              and organic leftovers into high-value raw material pipelines.
            </p>
            {/* Social Icons */}
            <div className="flex items-center gap-4">
              <a
                href="#"
                className="w-9 h-9 rounded-lg bg-emerald-900/50 hover:bg-emerald-500 hover:text-emerald-950 flex items-center justify-center transition-colors text-slate-300"
                aria-label="Twitter"
              >
                <FaTwitter size={16} />
              </a>
          ...
          <div className="lg:col-span-3 flex flex-col items-start text-left">
            ...
            <p className="text-slate-400 text-xs leading-relaxed mb-4">
              Get updates about regional raw materials directories and
